<template>
    <div class="introduction">
        ...
        <div class="protrack">
            ProTrack: <br>Pan-cancer KEA3
        </div>

        <div class="cptac-description">
            <p>This interactive data portal supports query, visualization, and downloads of multi-omics data from a comprehensive proteogenomic study of high-grade serous ovarian cancer, a collaborative project by <a href="https://proteomics.cancer.gov/programs/cptac">Clinical Proteomic Tumor Analysis Consortium (CPTAC).</a></p>
